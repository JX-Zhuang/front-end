        ...
        $verify.bind('blur', function() {
            ...
            if (check) {
                ...
                $.ajax(self.remote({
                    ...
                    error: function() {
                        if(typeof stat != 'undefined') stat.efunc({po:91033});
                                    ...
                                    self.submit({
                                        ...
                                        error: function(res) {
                                            if (res.msg == '手机验证码错误或过期') {
                                                if(typeof stat != 'undefined') stat.efunc({po:91036});
                                            }
                                        },
                                        success: function() {
